				...
				<div class="row">
					<div class="col-md-6 border-right">
						...
						<div class="form-group d-flex justify-content-center align-items-center">
							<img src="<?php echo isset($image) ? 'assets/uploads/'.$image :'' ?>" alt="image" id="cimg" class="img-fluid img-thumbnail ">
						</div>
					</div>
					<div class="col-md-6">
						
					<div class="form-group">
							<label for="" class="control-label">File hint</label>
							<input type="text" name="file_code" class="form-control form-control-sm" required value="<?php echo isset($file_code) ? $file_code : '' ?>">
						</div>
						
						<div class="form-group">
							<label for="" class="control-label">File Description</label>
							<textarea name="detail" class="form-control form-control-sm" required value="<?php echo isset($detail) ? $detail : '' ?>"></textarea>
						</div>
			   <div class="form-group">
					<label for="" class="control-label">Publish Date</label>
