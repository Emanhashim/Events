		...
		<div class="card-body">
			<form action="" id="manage_file">
				...
				<div class="row">
					<div class="col-md-6 border-right">
						<div class="form-group">
							<label for="" class="control-label">Transportation</label>
							<input type="text" name="transport_type" class="form-control form-control-sm" required value="<?php echo isset($transport_type) ? $transport_type : '' ?>">
						</div>						
				...
				<div class="col-lg-12 text-right justify-content-center d-flex">
					...
					<button class="btn btn-secondary" type="button" onclick="location.href = 'index.php?page=transport_list'">Cancel</button>
				</div>
			</form>
		</div>
	</div>
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					...
					setTimeout(function(){
						location.replace('index.php?page=transport_list')
					},750)
				}else if(resp == 2){
